...
model Sink_pT
  "Sink with prescribed pressure, temperature, composition and trace substances"
  extends IBPSA.Fluid.Sources.BaseClasses.PartialSink_p;
  extends IBPSA.Fluid.Sources.BaseClasses.PartialSink_T;
  extends IBPSA.Fluid.Sources.BaseClasses.PartialSink_Xi_C;
